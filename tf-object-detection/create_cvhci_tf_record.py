...
r"""Convert raw CVHCI dataset to TFRecord for object_detection.

Example usage:
	./create_cvhci_tf_record --data_dir=data/CVHCI \
		--output_path=/home/user/cvhci.record
"""
...
flags = tf.app.flags
flags.DEFINE_string('data_dir', 'data/CVHCI', 'Root directory to raw CVHCI dataset.')
...
flags.DEFINE_string('image_dir', 'data/CVHCI/Images', '(Relative) path to image directory.')
flags.DEFINE_string('output_path', 'data', 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', 'data/cvhci_label_map.pbtxt', 'Path to label map proto')

FLAGS = flags.FLAGS

SETS = ['train', 'val', 'trainval', 'test']

def dict_to_tf_example(data, dataset_directory, label_map_dict, image_subdirectory, annotation_path):
...
def main(_):
	...
	for idx, example in enumerate(examples_list):
		...
		tf_example = dict_to_tf_example(data, FLAGS.data_dir, label_map_dict, FLAGS.image_dir, path)
